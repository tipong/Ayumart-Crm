...
return new class extends Migration
{
    /**
     * Run the migrations.
     * Final restructure tb_transaksi table dengan struktur lengkap
     */
    public function up(): void
    {
        ...
        // Create new tb_transaksi table dengan struktur final
        Schema::create('tb_transaksi', function (Blueprint $table) {
            // Primary key
            $table->integer('id_transaksi', false, true)->length(11)->primary();

            // Foreign keys
            $table->integer('id_pelanggan')->length(11);
            $table->integer('id_cabang')->length(11)->nullable();
            ...
            $table->string('ongkir', 50)->default('0'); // Bisa varchar untuk menyimpan format text
        ...
        foreach ($existingTransactions as $transaction) {
            DB::table('tb_transaksi')->insert([
                ...
                'id_cabang' => $transaction->id_cabang ?? null,
                'kode_transaksi' => $transaction->kode_transaksi,
                'tanggal_transaksi' => $transaction->tanggal_transaksi ?? now(),
