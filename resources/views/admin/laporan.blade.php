    ...
    <div class="row justify-content-center">
                    ...
                    <form action="{{ route('admin.laporan.download') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="bulan_all" class="form-label fw-bold">
                                <i class="far fa-calendar"></i> Bulan
                            </label>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow-sm h-100">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.laporan.download-cabang') }}" method="POST">
                        @csrf
        ...
        <div class="col-lg-12">
            <div class="alert alert-info">
                ...
                <ul class="mb-0">
                    ...
                    <li>Laporan hanya mencakup transaksi dengan status pembayaran: <span class="badge bg-success text-white">Sudah Bayar</span></li>
